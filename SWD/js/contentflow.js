...
ContentFlow.prototype = {
    ...
    _defaultConf: { 
        ...
        circularFlow: true,
        verticalFlow: false,
        visibleItems: 2,//左右可視物件的數量
        endOpacity: 0.7,//左右透明度數值
        startItem:  "center",
        scrollInFrom: "pre",
        ...
        reflectionHeight: 0.3,          // float (relative to original image height)倒影高度
        reflectionGap: 0.0,
        ...
        calcCoordinates: function (item) {
            ...
            var f = 1 - 1/Math.exp( Math.abs(rP)*1);/////左右大小調整
            var x =  item.side * vI/(vI+0.5)* f; /////左右位置調整
            var y = 1;
